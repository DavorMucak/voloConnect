    ...
    <div v-if="groupedRecenzije.length">
      <div v-for="project in groupedRecenzije" :key="project.projectId" class="project-group">
        ...
        <div v-for="pair in project.pairs" :key="pair.recenzija.id" class="recenzija-pair">
          <div class="recenzija">
            <p>
              <router-link :to="`/profil/${pair.recenzija.volonteerUsername}`">{{ getUserName(pair.recenzija.volonteerUsername) }}</router-link>
              >
              <router-link :to="`/profil/${pair.recenzija.organizationUsername}`">{{ getUserName(pair.recenzija.organizationUsername) }}</router-link>
            </p>
          ...
          <div v-if="pair.feedback" class="feedback">
            <p>
              <router-link :to="`/profil/${pair.feedback.organizationUsername}`">{{ getUserName(pair.feedback.organizationUsername) }}</router-link>
              >
              <router-link :to="`/profil/${pair.feedback.volonteerUsername}`">{{ getUserName(pair.feedback.volonteerUsername) }}</router-link>
            </p>
